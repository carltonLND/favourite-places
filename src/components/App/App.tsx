...
import { PlaceCard, PlaceCardProps } from "../PlaceCard/placeCard";
import "./App.css";

const landsEnd: PlaceCardProps = {
...
const londonEye: PlaceCardProps = {
  ...
  description:
    "The London Eye, or the Millennium Wheel, is a cantilevered observation wheel on the South Bank of the River Thames in London. It is Europe's tallest cantilevered observation wheel,[14] and the most popular paid tourist attraction in the United Kingdom with over three million visitors annually.",
};
